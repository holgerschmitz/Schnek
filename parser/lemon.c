...
int mhflag;                 /* True if generating makeheaders output */
{
  ...
  */
  ...
  fprintf(out,"struct YYMINORTYPE {\n"); lineno++;
  fprintf(out,"  int yyinit;\n"); lineno++;
  fprintf(out,"  %sTOKENTYPE yy0;\n",name); lineno++;
  fprintf(out,"  YYMINORTYPE(int yyinit_, %sTOKENTYPE yy0_=%sTOKENTYPE()) : yyinit(yyinit_), yy0(yy0_) {}\n",name,name); lineno++;
  fprintf(out,"  YYMINORTYPE(%sTOKENTYPE yy0_=%sTOKENTYPE()) : yyinit(0), yy0(yy0_) {}\n",name,name); lineno++;
  fprintf(out,"  YYMINORTYPE &operator=(const YYMINORTYPE &rhs) { yyinit = rhs.yyinit; yy0 = rhs.yy0; return *this;}\n"); lineno++;
