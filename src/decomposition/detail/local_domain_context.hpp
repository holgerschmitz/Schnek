...
namespace schnek {
  ...
  namespace detail {
    ...
    class LocalDomainIteratorImpl : public schnek::LocalDomainIterator {
      ...
      public:
        LocalDomainIteratorImpl(GridFactory &gridFactory, const std::vector<pLocalDomain> &domains)
            : gridFactory(gridFactory), domains(domains), pos(0) {}
        ...
        const LocalDomain &getDomain() const { return *domains[pos]; }
