...
namespace schnek {
  ...
  class Range {
    ...
    public:
      ...
      void grow(
          const T &d0, const T &d1, const T &d2, const T &d3, const T &d4, const T &d5, const T &d6, const T &d7
      ) {
      ...
      class iterator {
        ...
        private:
          ...
          void increment() {
            if (pos[rank-1] < domain.getHi()[rank-1]) {
              ++pos[rank-1];
              return;
            }
            
            pos[rank-1] = domain.getLo()[rank-1];
        ...
        public:
          ...
          /// Equality test
          bool operator==(const iterator &it) { return (atEnd == it.atEnd) && (pos == it.pos); }
